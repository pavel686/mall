...
<html>
  <head>
    ...
    <script type="text/javascript" src="https://kyfw.12306.cn/otn/resources/js/rich/calender_double/datepicker/WdatePicker.js"></script>
			...
			<div class="info">
				...
				<form class="sui-form form-horizontal" action="register" method="post" enctype="multipart/form-data" onsubmit="return checkPassword()">
					...
					<div class="control-group">
						...
						<div class="controls">
							<input type="text" name="birthday" onFocus="WdatePicker({lang:'zh-cn'})"  placeholder="出生日期" class="input-xfat input-xlarge Wdate">
						</div>
					</div>
